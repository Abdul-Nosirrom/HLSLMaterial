...
#include "HLSLMaterialEditorInstanceDetailCustomization.h"
...
TSharedRef<IDetailCustomization> FHLSLMaterialInstanceParameterDetails::MakeInstance(UMaterialEditorInstanceConstant* MaterialInstance, FGetShowHiddenParameters InShowHiddenDelegate)
{
	return MakeShareable(new FHLSLMaterialInstanceParameterDetails(MaterialInstance, InShowHiddenDelegate));
}

FHLSLMaterialInstanceParameterDetails::FHLSLMaterialInstanceParameterDetails(UMaterialEditorInstanceConstant* MaterialInstance, FGetShowHiddenParameters InShowHiddenDelegate)
	: MaterialEditorInstance(MaterialInstance)
	, ShowHiddenDelegate(InShowHiddenDelegate)
{
}

TOptional<float> FHLSLMaterialInstanceParameterDetails::OnGetValue(TSharedRef<IPropertyHandle> PropertyHandle)
{
	float Value = 0.0f;
...
void FHLSLMaterialInstanceParameterDetails::OnValueCommitted(float NewValue, ETextCommit::Type CommitType, TSharedRef<IPropertyHandle> PropertyHandle)
{	
	// Try setting as float, if that fails then set as int
	ensure(PropertyHandle->SetValue(NewValue) == FPropertyAccess::Success);
}

FString FHLSLMaterialInstanceParameterDetails::GetFunctionParentPath() const
{
	FString PathString;
...
void FHLSLMaterialInstanceParameterDetails::CustomizeDetails(IDetailLayoutBuilder& DetailLayout)
{
		...
		if (bShowParent)
		{
			...
			.ValueContent()
				...
				[
					...
					.ObjectPath(this, &FHLSLMaterialInstanceParameterDetails::GetFunctionParentPath)
					.AllowedClass(UMaterialFunctionInterface::StaticClass())
					.ThumbnailPool(DetailLayout.GetThumbnailPool())
					.AllowClear(true)
					.OnObjectChanged(this, &FHLSLMaterialInstanceParameterDetails::OnAssetChanged, ParentPropertyHandle)
					.OnShouldSetAsset(this, &FHLSLMaterialInstanceParameterDetails::OnShouldSetAsset)
	...
	else
	{
...

		{
			...
			PropertyRow.Visibility(TAttribute<EVisibility>::Create(TAttribute<EVisibility>::FGetter::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::ShouldShowMaterialRefractionSettings)));
...

		{
			...
			PropertyRow
				...
				.Visibility(TAttribute<EVisibility>::Create(TAttribute<EVisibility>::FGetter::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::ShouldShowSubsurfaceProfile)));
...
void FHLSLMaterialInstanceParameterDetails::CreateGroupsWidget(TSharedRef<IPropertyHandle> ParameterGroupsProperty, IDetailCategoryBuilder& GroupsCategory)
{
			...
			&& ParameterGroup.GroupName != FMaterialPropertyHelpers::LayerParamName)
		{
			...
			if (bCreateGroup)
			{
				...
				FUIAction CopyAction(
					FExecuteAction::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::OnCopyParameterValues, GroupIdx),
					FCanExecuteAction::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::CanCopyParameterValues, GroupIdx));
				FUIAction PasteAction(
					FExecuteAction::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::OnPasteParameterValues, GroupIdx),
					FCanExecuteAction::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::CanPasteParameterValues, GroupIdx));
...
void FHLSLMaterialInstanceParameterDetails::EnableGroupParameters(FEditorParameterGroup& ParameterGroup, bool ShouldEnable)
{
...
void FHLSLMaterialInstanceParameterDetails::CreateSingleGroupWidget(FEditorParameterGroup& ParameterGroup, TSharedPtr<IPropertyHandle> ParameterGroupProperty, IDetailGroup& DetailGroup )
{
...
void FHLSLMaterialInstanceParameterDetails::CreateParameterValueWidget(UDEditorParameterValue* Parameter, TSharedPtr<IPropertyHandle> ParameterProperty, IDetailGroup& DetailGroup)
{
	TSharedPtr<IPropertyHandle> ParameterValueProperty = ParameterProperty->GetChildHandle("ParameterValue");
...
void FHLSLMaterialInstanceParameterDetails::CreateMaskParameterValueWidget(UDEditorParameterValue* Parameter, TSharedPtr<IPropertyHandle> ParameterProperty, IDetailGroup& DetailGroup )
{
	TSharedPtr<IPropertyHandle> ParameterValueProperty = ParameterProperty->GetChildHandle("ParameterValue");
...
void FHLSLMaterialInstanceParameterDetails::CreateVectorChannelMaskParameterValueWidget(UDEditorParameterValue* Parameter, TSharedPtr<IPropertyHandle> ParameterProperty, IDetailGroup& DetailGroup)
{
	TSharedPtr<IPropertyHandle> ParameterValueProperty = ParameterProperty->GetChildHandle("ParameterValue");
...
void FHLSLMaterialInstanceParameterDetails::CreateScalarAtlasPositionParameterValueWidget(class UDEditorParameterValue* Parameter, TSharedPtr<IPropertyHandle> ParameterProperty, IDetailGroup& DetailGroup)
{
	TSharedPtr<IPropertyHandle> ParameterValueProperty = ParameterProperty->GetChildHandle("ParameterValue");
	...
	if (ParameterValueProperty->IsValidHandle())
	{
		...
		CustomWidget
			...
			[
				SNew(SObjectPropertyEntryBox)
				.ObjectPath(this, &FHLSLMaterialInstanceParameterDetails::GetCurvePath, AtlasParameter)
...
void FHLSLMaterialInstanceParameterDetails::CreateLabeledTextureParameterValueWidget(class UDEditorParameterValue* Parameter, TSharedPtr<IPropertyHandle> ParameterProperty, IDetailGroup& DetailGroup)
{
	TSharedPtr<IPropertyHandle> ParameterValueProperty = ParameterProperty->GetChildHandle("ParameterValue");
...
FString FHLSLMaterialInstanceParameterDetails::GetCurvePath(UDEditorScalarParameterValue* Parameter) const
{
	FString Path = Parameter->AtlasData.Curve->GetPathName();
	return Path;
}

bool FHLSLMaterialInstanceParameterDetails::IsVisibleExpression(UDEditorParameterValue* Parameter)
{
	return MaterialEditorInstance->VisibleExpressions.Contains(Parameter->ParameterInfo);
}

EVisibility FHLSLMaterialInstanceParameterDetails::ShouldShowExpression(UDEditorParameterValue* Parameter) const
{
	return FMaterialPropertyHelpers::ShouldShowExpression(Parameter, MaterialEditorInstance, ShowHiddenDelegate);
}

bool FHLSLMaterialInstanceParameterDetails::OnShouldSetAsset(const FAssetData& AssetData) const
{
	if (MaterialEditorInstance->bIsFunctionPreviewMaterial)
	{
		if (MaterialEditorInstance->SourceFunction->GetMaterialFunctionUsage() == EMaterialFunctionUsage::Default)
...
void FHLSLMaterialInstanceParameterDetails::OnAssetChanged(const FAssetData & InAssetData, TSharedRef<IPropertyHandle> InHandle)
{
	if (MaterialEditorInstance->bIsFunctionPreviewMaterial &&
...
EVisibility FHLSLMaterialInstanceParameterDetails::ShouldShowMaterialRefractionSettings() const
{
...
EVisibility FHLSLMaterialInstanceParameterDetails::ShouldShowSubsurfaceProfile() const
{
...
void FHLSLMaterialInstanceParameterDetails::OnCopyParameterValues(int32 ParameterGroupIndex)
{
...
bool FHLSLMaterialInstanceParameterDetails::CanCopyParameterValues(int32 ParameterGroupIndex)
{
...
void FHLSLMaterialInstanceParameterDetails::OnPasteParameterValues(int32 ParameterGroupIndex)
{
	if (!MaterialEditorInstance || !MaterialEditorInstance->ParameterGroups.IsValidIndex(ParameterGroupIndex))
	{
		return;
...
bool FHLSLMaterialInstanceParameterDetails::CanPasteParameterValues(int32 ParameterGroupIndex)
{
...
void FHLSLMaterialInstanceParameterDetails::CreateLightmassOverrideWidgets(IDetailLayoutBuilder& DetailLayout)
{
	...
	CastShadowAsMaskedPropertyRow
		...
		.Visibility(TAttribute<EVisibility>::Create(TAttribute<EVisibility>::FGetter::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::IsOverriddenAndVisible, IsOverrideCastShadowAsMaskedEnabled)))
	...
	EmissiveBoostPropertyRow
		...
		.Visibility(TAttribute<EVisibility>::Create(TAttribute<EVisibility>::FGetter::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::IsOverriddenAndVisible, IsOverrideEmissiveBoostEnabled)))
	...
	DiffuseBoostPropertyRow
		...
		.Visibility(TAttribute<EVisibility>::Create(TAttribute<EVisibility>::FGetter::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::IsOverriddenAndVisible, IsOverrideDiffuseBoostEnabled)))
	...
	ExportResolutionScalePropertyRow
		...
		.Visibility(TAttribute<EVisibility>::Create(TAttribute<EVisibility>::FGetter::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::IsOverriddenAndVisible, IsOverrideExportResolutionScaleEnabled)))
...
void FHLSLMaterialInstanceParameterDetails::CreateBasePropertyOverrideWidgets(IDetailLayoutBuilder& DetailLayout, IDetailGroup& MaterialPropertyOverrideGroup)
{
	IDetailGroup& BasePropertyOverrideGroup = MaterialPropertyOverrideGroup;

	TAttribute<bool> IsOverrideOpacityClipMaskValueEnabled = TAttribute<bool>::Create(TAttribute<bool>::FGetter::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::OverrideOpacityClipMaskValueEnabled));
	TAttribute<bool> IsOverrideBlendModeEnabled = TAttribute<bool>::Create(TAttribute<bool>::FGetter::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::OverrideBlendModeEnabled));
	TAttribute<bool> IsOverrideShadingModelEnabled = TAttribute<bool>::Create(TAttribute<bool>::FGetter::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::OverrideShadingModelEnabled));
	TAttribute<bool> IsOverrideTwoSidedEnabled = TAttribute<bool>::Create(TAttribute<bool>::FGetter::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::OverrideTwoSidedEnabled));
	TAttribute<bool> IsOverrideIsThinSurfaceEnabled = TAttribute<bool>::Create(TAttribute<bool>::FGetter::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::OverrideIsThinSurfaceEnabled));
	TAttribute<bool> IsOverrideDitheredLODTransitionEnabled = TAttribute<bool>::Create(TAttribute<bool>::FGetter::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::OverrideDitheredLODTransitionEnabled));
	TAttribute<bool> IsOverrideOutputTranslucentVelocityEnabled = TAttribute<bool>::Create(TAttribute<bool>::FGetter::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::OverrideOutputTranslucentVelocityEnabled));
	TAttribute<bool> IsOverrideHasPixelAnimationEnabled = TAttribute<bool>::Create(TAttribute<bool>::FGetter::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::OverrideHasPixelAnimationEnabled));
	TAttribute<bool> IsOverrideTessellationEnabled = TAttribute<bool>::Create(TAttribute<bool>::FGetter::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::OverrideTessellationEnabled));
	TAttribute<bool> IsOverrideDisplacementScalingEnabled = TAttribute<bool>::Create(TAttribute<bool>::FGetter::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::OverrideDisplacementScalingEnabled));
	TAttribute<bool> IsOverrideMaxWorldPositionOffsetDisplacementEnabled = TAttribute<bool>::Create(TAttribute<bool>::FGetter::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::OverrideMaxWorldPositionOffsetDisplacementEnabled));
	TAttribute<bool> IsOverrideCastDynamicShadowAsMaskedEnabled = TAttribute<bool>::Create(TAttribute<bool>::FGetter::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::OverrideCastDynamicShadowAsMaskedEnabled));
...

	{
		...
		OpacityClipMaskValuePropertyRow
			...
			.EditCondition(IsOverrideOpacityClipMaskValueEnabled, FOnBooleanValueChanged::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::OnOverrideOpacityClipMaskValueChanged))
			.Visibility(TAttribute<EVisibility>::Create(TAttribute<EVisibility>::FGetter::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::IsOverriddenAndVisible, IsOverrideOpacityClipMaskValueEnabled)))
	...
	}
	{
		...
		BlendModePropertyRow
			...
			.EditCondition(IsOverrideBlendModeEnabled, FOnBooleanValueChanged::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::OnOverrideBlendModeChanged))
			.Visibility(TAttribute<EVisibility>::Create(TAttribute<EVisibility>::FGetter::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::IsOverriddenAndVisible, IsOverrideBlendModeEnabled)))
	...
	}
	{
		...
		ShadingModelPropertyRow
			...
			.EditCondition(IsOverrideShadingModelEnabled, FOnBooleanValueChanged::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::OnOverrideShadingModelChanged))
			.Visibility(TAttribute<EVisibility>::Create(TAttribute<EVisibility>::FGetter::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::IsOverriddenAndVisible, IsOverrideShadingModelEnabled)))
	...
	}
	{
		...
		TwoSidedPropertyRow
			...
			.EditCondition(IsOverrideTwoSidedEnabled, FOnBooleanValueChanged::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::OnOverrideTwoSidedChanged))
			.Visibility(TAttribute<EVisibility>::Create(TAttribute<EVisibility>::FGetter::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::IsOverriddenAndVisible, IsOverrideTwoSidedEnabled)))
	...
	if (IsThinSurfaceProperty)
	{
		...
		IsThinSurfacePropertyRow
			...
			.EditCondition(IsOverrideIsThinSurfaceEnabled, FOnBooleanValueChanged::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::OnOverrideIsThinSurfaceChanged))
			.Visibility(TAttribute<EVisibility>::Create(TAttribute<EVisibility>::FGetter::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::IsOverriddenAndVisible, IsOverrideIsThinSurfaceEnabled)))
	...
	}
	{
		...
		DitheredLODTransitionPropertyRow
			...
			.EditCondition(IsOverrideDitheredLODTransitionEnabled, FOnBooleanValueChanged::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::OnOverrideDitheredLODTransitionChanged))
			.Visibility(TAttribute<EVisibility>::Create(TAttribute<EVisibility>::FGetter::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::IsOverriddenAndVisible, IsOverrideDitheredLODTransitionEnabled)))
	...
	}
	{
		...
		OutputTranslucentVelocityPropertyRow
			...
			.EditCondition(IsOverrideOutputTranslucentVelocityEnabled, FOnBooleanValueChanged::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::OnOverrideOutputTranslucentVelocityChanged))
			.Visibility(TAttribute<EVisibility>::Create(TAttribute<EVisibility>::FGetter::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::IsOverriddenAndVisible, IsOverrideOutputTranslucentVelocityEnabled)))
	...
	}
	{
		...
		HasPixelAnimationPropertyRow
			...
			.EditCondition(IsOverrideHasPixelAnimationEnabled, FOnBooleanValueChanged::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::OnOverrideHasPixelAnimationChanged))
			.Visibility(TAttribute<EVisibility>::Create(TAttribute<EVisibility>::FGetter::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::IsOverriddenAndVisible, IsOverrideHasPixelAnimationEnabled)))
	...
	}
	{
		...
		EnableTessellationPropertyRow
			...
			.EditCondition(IsOverrideTessellationEnabled, FOnBooleanValueChanged::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::OnOverrideEnableTessellationChanged))
			.Visibility(TAttribute<EVisibility>::Create(TAttribute<EVisibility>::FGetter::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::IsOverriddenAndVisible, IsOverrideTessellationEnabled)))
	...
	}
	{
		...
		DisplacementScalingPropertyRow
			...
			.EditCondition(IsOverrideDisplacementScalingEnabled, FOnBooleanValueChanged::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::OnOverrideDisplacementScalingChanged))
			.Visibility(TAttribute<EVisibility>::Create(TAttribute<EVisibility>::FGetter::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::IsOverriddenAndVisible, IsOverrideDisplacementScalingEnabled)))
	...
	}
	{
		...
		MaxWorldPositionOffsetDisplacementPropertyRow
			...
			.EditCondition(IsOverrideMaxWorldPositionOffsetDisplacementEnabled, FOnBooleanValueChanged::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::OnOverrideMaxWorldPositionOffsetDisplacementChanged))
			.Visibility(TAttribute<EVisibility>::Create(TAttribute<EVisibility>::FGetter::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::IsOverriddenAndVisible, IsOverrideMaxWorldPositionOffsetDisplacementEnabled)))
	...
	}
	{
		...
		CastDynamicShadowAsMaskedPropertyRow
			...
			.EditCondition(IsOverrideCastDynamicShadowAsMaskedEnabled, FOnBooleanValueChanged::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::OnOverrideCastDynamicShadowAsMaskedChanged))
			.Visibility(TAttribute<EVisibility>::Create(TAttribute<EVisibility>::FGetter::CreateSP(this, &FHLSLMaterialInstanceParameterDetails::IsOverriddenAndVisible, IsOverrideCastDynamicShadowAsMaskedEnabled)))
			.OverrideResetToDefault(ResetCastDynamicShadowAsMaskedPropertyOverride);
	}
}

EVisibility FHLSLMaterialInstanceParameterDetails::IsOverriddenAndVisible(TAttribute<bool> IsOverridden) const
{
...
bool FHLSLMaterialInstanceParameterDetails::OverrideOpacityClipMaskValueEnabled() const
{
	return MaterialEditorInstance->BasePropertyOverrides.bOverride_OpacityMaskClipValue;
}

bool FHLSLMaterialInstanceParameterDetails::OverrideBlendModeEnabled() const
{
	return MaterialEditorInstance->BasePropertyOverrides.bOverride_BlendMode;
}

bool FHLSLMaterialInstanceParameterDetails::OverrideShadingModelEnabled() const
{
	return MaterialEditorInstance->BasePropertyOverrides.bOverride_ShadingModel;
}

bool FHLSLMaterialInstanceParameterDetails::OverrideTwoSidedEnabled() const
{
	return MaterialEditorInstance->BasePropertyOverrides.bOverride_TwoSided;
}

bool FHLSLMaterialInstanceParameterDetails::OverrideIsThinSurfaceEnabled() const
{
	return MaterialEditorInstance->BasePropertyOverrides.bOverride_bIsThinSurface;
}

bool FHLSLMaterialInstanceParameterDetails::OverrideDitheredLODTransitionEnabled() const
{
	return MaterialEditorInstance->BasePropertyOverrides.bOverride_DitheredLODTransition;
}

bool FHLSLMaterialInstanceParameterDetails::OverrideOutputTranslucentVelocityEnabled() const
{
	return MaterialEditorInstance->BasePropertyOverrides.bOverride_OutputTranslucentVelocity;
}

bool FHLSLMaterialInstanceParameterDetails::OverrideHasPixelAnimationEnabled() const
{
	return MaterialEditorInstance->BasePropertyOverrides.bOverride_bHasPixelAnimation;
}

bool FHLSLMaterialInstanceParameterDetails::OverrideTessellationEnabled() const
{
	return MaterialEditorInstance->BasePropertyOverrides.bOverride_bEnableTessellation;
}

bool FHLSLMaterialInstanceParameterDetails::OverrideDisplacementScalingEnabled() const
{
	return MaterialEditorInstance->BasePropertyOverrides.bOverride_DisplacementScaling;
}

bool FHLSLMaterialInstanceParameterDetails::OverrideMaxWorldPositionOffsetDisplacementEnabled() const
{
	return MaterialEditorInstance->BasePropertyOverrides.bOverride_MaxWorldPositionOffsetDisplacement;
}

bool FHLSLMaterialInstanceParameterDetails::OverrideCastDynamicShadowAsMaskedEnabled() const
{
...
void FHLSLMaterialInstanceParameterDetails::OnOverrideCastDynamicShadowAsMaskedChanged(bool NewValue)
{
...
void FHLSLMaterialInstanceParameterDetails::OnOverrideOpacityClipMaskValueChanged(bool NewValue)
{
	if (DoesSourceMaterialInstanceDisallowStaticParameterPermutation(MaterialEditorInstance, NewValue))
	{
		return;
...
void FHLSLMaterialInstanceParameterDetails::OnOverrideBlendModeChanged(bool NewValue)
{
	if (DoesSourceMaterialInstanceDisallowStaticParameterPermutation(MaterialEditorInstance, NewValue))
	{
		return;
...
void FHLSLMaterialInstanceParameterDetails::OnOverrideShadingModelChanged(bool NewValue)
{
	if (DoesSourceMaterialInstanceDisallowStaticParameterPermutation(MaterialEditorInstance, NewValue))
	{
		return;
...
void FHLSLMaterialInstanceParameterDetails::OnOverrideTwoSidedChanged(bool NewValue)
{
	if (DoesSourceMaterialInstanceDisallowStaticParameterPermutation(MaterialEditorInstance, NewValue))
	{
		return;
...
void FHLSLMaterialInstanceParameterDetails::OnOverrideIsThinSurfaceChanged(bool NewValue)
{
	if (DoesSourceMaterialInstanceDisallowStaticParameterPermutation(MaterialEditorInstance, NewValue))
	{
		return;
...
void FHLSLMaterialInstanceParameterDetails::OnOverrideDitheredLODTransitionChanged(bool NewValue)
{
	if (DoesSourceMaterialInstanceDisallowStaticParameterPermutation(MaterialEditorInstance, NewValue))
	{
		return;
...
void FHLSLMaterialInstanceParameterDetails::OnOverrideOutputTranslucentVelocityChanged(bool NewValue)
{
	if (DoesSourceMaterialInstanceDisallowStaticParameterPermutation(MaterialEditorInstance, NewValue))
	{
		return;
...
void FHLSLMaterialInstanceParameterDetails::OnOverrideHasPixelAnimationChanged(bool NewValue)
{
	if (DoesSourceMaterialInstanceDisallowStaticParameterPermutation(MaterialEditorInstance, NewValue))
	{
		return;
...
void FHLSLMaterialInstanceParameterDetails::OnOverrideEnableTessellationChanged(bool NewValue)
{
	if (DoesSourceMaterialInstanceDisallowStaticParameterPermutation(MaterialEditorInstance, NewValue))
	{
		return;
...
void FHLSLMaterialInstanceParameterDetails::OnOverrideDisplacementScalingChanged(bool NewValue)
{
...
void FHLSLMaterialInstanceParameterDetails::OnOverrideMaxWorldPositionOffsetDisplacementChanged(bool NewValue)
{
	if (DoesSourceMaterialInstanceDisallowStaticParameterPermutation(MaterialEditorInstance, NewValue))
	{
		return;
