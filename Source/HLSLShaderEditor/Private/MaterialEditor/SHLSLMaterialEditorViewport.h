...
class FHLSLMaterialEditorViewportClient;
 ...
 */
class SHLSLMaterialEditor3DPreviewViewport : public SEditorViewport, public FGCObject, public ICommonEditorViewportToolbarInfoProvider
{
public:
	SLATE_BEGIN_ARGS( SHLSLMaterialEditor3DPreviewViewport ){}
		SLATE_ARGUMENT(TWeakPtr<IMaterialEditor>, MaterialEditor)
	SLATE_END_ARGS()

	void Construct(const FArguments& InArgs);
	~SHLSLMaterialEditor3DPreviewViewport();
...
private:
	...
	TSharedPtr<class FHLSLMaterialEditorViewportClient> EditorViewportClient;
 ...
 */
class SHLSLMaterialEditorUIPreviewViewport : public SCompoundWidget
{
public:
	SLATE_BEGIN_ARGS( SHLSLMaterialEditorUIPreviewViewport ){}
	SLATE_END_ARGS()

	void Construct( const FArguments& InArgs, UMaterialInterface* PreviewMaterial );
	virtual ~SHLSLMaterialEditorUIPreviewViewport();
