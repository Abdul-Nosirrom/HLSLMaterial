...
class HLSLSHADEREDITOR_API FHLSLMaterialInstanceParameterDetails : public IDetailCustomization
{
public:
	...
	/** Constructor */
	FHLSLMaterialInstanceParameterDetails(UMaterialEditorInstanceConstant* MaterialInstance, FGetShowHiddenParameters InShowHiddenDelegate);
